...
<head>
    <title>Code coverage report for node-npmtest-lodash/node_modules/lodash/_shortOut.js</title>
    <meta charset="utf-8">
<style>
/* jslint-utility2 */
/*csslint
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-lodash/node_modules/lodash/_shortOut.js</span></h1>
    ...
    <tbody>
        ...
        <td>92.31%<br>(12 / 13)</td>
        <td>75%<br>(3 / 4)</td>
        <td>100%<br>(2 / 2)</td>
        <td>92.31%<br>(12 / 13)</td>
    </tbody>
    </table>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-lodash/node_modules/lodash/</a> &#187; _shortOut.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js" tabIndex="0">/** Used to detect hot functions by number of calls within a span of milliseconds. */
var HOT_COUNT = 800,
    HOT_SPAN = 16;
&nbsp;
...
&nbsp;
    lastCalled = stamp;
    if (remaining &gt; 0) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (++count &gt;= HOT_COUNT) {
