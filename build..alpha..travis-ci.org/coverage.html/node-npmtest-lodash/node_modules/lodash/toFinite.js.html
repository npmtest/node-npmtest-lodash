...
<head>
    <title>Code coverage report for node-npmtest-lodash/node_modules/lodash/toFinite.js</title>
    <meta charset="utf-8">
<style>
/* jslint-utility2 */
/*csslint
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-lodash/node_modules/lodash/toFinite.js</span></h1>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-lodash/node_modules/lodash/</a> &#187; toFinite.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js" tabIndex="0">var toNumber = require('./toNumber');
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    return value === 0 ? value : 0;</span>
  }
  value = toNumber(value);
  <span class="missing-if-branch" title="if path not taken" >I</span>if (value === INFINITY || value === -INFINITY) {
<span class="cstat-no" title="statement not covered" >    var sign = (value &lt; 0 ? -1 : 1);</span>
<span class="cstat-no" title="statement not covered" >    return sign * MAX_INTEGER;</span>
  }
  return value === value ? value : <span class="branch-1 cbranch-no" title="branch not covered" >0;</span>
}
&nbsp;
