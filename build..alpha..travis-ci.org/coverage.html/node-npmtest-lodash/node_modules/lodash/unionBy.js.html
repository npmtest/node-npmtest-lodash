...
<head>
    <title>Code coverage report for node-npmtest-lodash/node_modules/lodash/unionBy.js</title>
    <meta charset="utf-8">
<style>
/* jslint-utility2 */
/*csslint
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-lodash/node_modules/lodash/unionBy.js</span></h1>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-lodash/node_modules/lodash/</a> &#187; unionBy.js</div>
</div>
<div class="body">
 ...
 * // =&gt; [{ 'x': 1 }, { 'x': 2 }]
 */
var unionBy = baseRest(<span class="fstat-no" title="function not covered" >function(arrays) {</span>
<span class="cstat-no" title="statement not covered" >  var iteratee = last(arrays);</span>
<span class="cstat-no" title="statement not covered" >  if (isArrayLikeObject(iteratee)) {</span>
<span class="cstat-no" title="statement not covered" >    iteratee = undefined;</span>
  }
<span class="cstat-no" title="statement not covered" >  return baseUniq(baseFlatten(arrays, 1, isArrayLikeObject, true), baseIteratee(iteratee, 2));</span>
});
&nbsp;
