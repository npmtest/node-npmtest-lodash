...
<head>
    <title>Code coverage report for node-npmtest-lodash/node_modules/lodash/_baseFlatten.js</title>
    <meta charset="utf-8">
<style>
/* jslint-utility2 */
/*csslint
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-lodash/node_modules/lodash/_baseFlatten.js</span></h1>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-lodash/node_modules/lodash/</a> &#187; _baseFlatten.js</div>
</div>
<div class="body">
...
&nbsp;
  while (++index &lt; length) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (depth &gt; 0 &amp;&amp; predicate(value)) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (depth &gt; 1) {
