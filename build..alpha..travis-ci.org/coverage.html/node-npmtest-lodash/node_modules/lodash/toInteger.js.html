...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js" tabIndex="0">var toFinite = require('./toFinite');
&nbsp;
/**
...
function toInteger(value) {
  var result = toFinite(value),
      remainder = result % 1;
&nbsp;
  return result === result ? (remainder ? <span class="branch-0 cbranch-no" title="branch not covered" >result - remainder </span>: result) : <span class="branch-1 cbranch-no" title="branch not covered" >0;</span>
}
&nbsp;
