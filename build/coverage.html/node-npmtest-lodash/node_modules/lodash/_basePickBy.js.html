...
<head>
    <title>Code coverage report for node-npmtest-lodash/node_modules/lodash/_basePickBy.js</title>
    <meta charset="utf-8">
<style>
/* jslint-utility2 */
/*csslint
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-lodash/node_modules/lodash/_basePickBy.js</span></h1>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-lodash/node_modules/lodash/</a> &#187; _basePickBy.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js" tabIndex="0">var baseGet = require('./_baseGet'),
 ...
 */
<span class="fstat-no" title="function not covered" >function basePickBy(object, paths, predicate) {</span>
...
<span class="cstat-no" title="statement not covered" >    var path = paths[index],</span>
        value = baseGet(object, path);
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (predicate(value, path)) {</span>
<span class="cstat-no" title="statement not covered" >      baseSet(result, castPath(path, object), value);</span>
    }
  }
