...
<head>
    <title>Code coverage report for node-npmtest-lodash/node_modules/lodash/every.js</title>
    <meta charset="utf-8">
<style>
/* jslint-utility2 */
/*csslint
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-lodash/node_modules/lodash/every.js</span></h1>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-lodash/node_modules/lodash/</a> &#187; every.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js" tabIndex="0">var arrayEvery = require('./_arrayEvery'),
...
<span class="cstat-no" title="statement not covered" >  var func = isArray(collection) ? arrayEvery : baseEvery;</span>
<span class="cstat-no" title="statement not covered" >  if (guard &amp;&amp; isIterateeCall(collection, predicate, guard)) {</span>
<span class="cstat-no" title="statement not covered" >    predicate = undefined;</span>
  }
<span class="cstat-no" title="statement not covered" >  return func(collection, baseIteratee(predicate, 3));</span>
}
&nbsp;
