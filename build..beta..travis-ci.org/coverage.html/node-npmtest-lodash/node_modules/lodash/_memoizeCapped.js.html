...
<head>
    <title>Code coverage report for node-npmtest-lodash/node_modules/lodash/_memoizeCapped.js</title>
    <meta charset="utf-8">
<style>
/* jslint-utility2 */
/*csslint
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-lodash/node_modules/lodash/_memoizeCapped.js</span></h1>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-lodash/node_modules/lodash/</a> &#187; _memoizeCapped.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js" tabIndex="0">var memoize = require('./memoize');
&nbsp;
...
function memoizeCapped(func) {
  var result = memoize(func, <span class="fstat-no" title="function not covered" >function(key) {</span>
<span class="cstat-no" title="statement not covered" >    if (cache.size === MAX_MEMOIZE_SIZE) {</span>
<span class="cstat-no" title="statement not covered" >      cache.clear();</span>
    }
