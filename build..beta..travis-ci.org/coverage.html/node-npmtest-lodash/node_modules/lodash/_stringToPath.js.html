...
<head>
    <title>Code coverage report for node-npmtest-lodash/node_modules/lodash/_stringToPath.js</title>
    <meta charset="utf-8">
<style>
/* jslint-utility2 */
/*csslint
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-lodash/node_modules/lodash/_stringToPath.js</span></h1>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-lodash/node_modules/lodash/</a> &#187; _stringToPath.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js" tabIndex="0">var memoizeCapped = require('./_memoizeCapped');
&nbsp;
 ...
 */
var stringToPath = memoizeCapped(<span class="fstat-no" title="function not covered" >function(string) {</span>
<span class="cstat-no" title="statement not covered" >  var result = [];</span>
<span class="cstat-no" title="statement not covered" >  if (string.charCodeAt(0) === 46 /* . */) {</span>
<span class="cstat-no" title="statement not covered" >    result.push('');</span>
  }
<span class="cstat-no" title="statement not covered" >  string.replace(rePropName, <span class="fstat-no" title="function not covered" >function(match, number, quote, subString) {</span></span>
<span class="cstat-no" title="statement not covered" >    result.push(quote ? subString.replace(reEscapeChar, '$1') : (number || match));</span>
  });
