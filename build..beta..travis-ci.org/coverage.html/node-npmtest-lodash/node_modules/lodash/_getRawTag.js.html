...
<head>
    <title>Code coverage report for node-npmtest-lodash/node_modules/lodash/_getRawTag.js</title>
    <meta charset="utf-8">
<style>
/* jslint-utility2 */
/*csslint
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-lodash/node_modules/lodash/_getRawTag.js</span></h1>
    ...
    <tbody>
        ...
        <td>94.12%<br>(16 / 17)</td>
        <td>50%<br>(3 / 6)</td>
        <td>100%<br>(1 / 1)</td>
        <td>94.12%<br>(16 / 17)</td>
    </tbody>
    </table>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-lodash/node_modules/lodash/</a> &#187; _getRawTag.js</div>
</div>
<div class="body">
...
&nbsp;
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (unmasked) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (isOwn) {
